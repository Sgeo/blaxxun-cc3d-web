...
Gv2CullGroup::Gv2CullGroup() : bboxOk(FALSE), lod (FALSE) ,level(0),range(0)
{
    ...
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2CullGroup::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2CullGroup::removeChildren,GvMFNode);
...
Gv2Transform::Gv2Transform() : scale(1,1,1)
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2Transform::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2Transform::removeChildren,GvMFNode);
...
Gv2MatrixTransform::Gv2MatrixTransform() 
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2MatrixTransform::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2MatrixTransform::removeChildren,GvMFNode);
...
Gv2Billboard::Gv2Billboard() : axisOfRotation(0,1,0)
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2Billboard::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2Billboard::removeChildren,GvMFNode);
...
GvHUD::GvHUD() : align(0) 
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,GvHUD::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,GvHUD::removeChildren,GvMFNode);
...
Gv2Collision::Gv2Collision() : collide(TRUE)
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2Collision::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2Collision::removeChildren,GvMFNode);
...
Gv2Selection::Gv2Selection() : collide(TRUE),select(TRUE)
{
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,Gv2Selection::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,Gv2Selection::removeChildren,GvMFNode);
