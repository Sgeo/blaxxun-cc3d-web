...
GvLayer::GvLayer() : viewpointStretch(TRUE), size(-1,-1)
{
    ...
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,GvLayer::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,GvLayer::removeChildren,GvMFNode);
...
GvLayer3D::GvLayer3D() : childrenLayer(0), childrenLayerSorted(0), size(-1,-1)
{
    ...
    GV_NODE_ADD_EVENT_IN_NAME(addChildrenLayer,GvLayer3D::addChildrenLayer,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildrenLayer,GvLayer3D::removeChildrenLayer,GvMFNode);
    ...
    // from Gv2group
    GV_NODE_ADD_FIELD(children);
    GV_NODE_ADD_EVENT_IN_NAME(addChildren,GvLayer3D::addChildren,GvMFNode);
    GV_NODE_ADD_EVENT_IN_NAME(removeChildren,GvLayer3D::removeChildren,GvMFNode);
